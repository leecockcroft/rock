  ...
  return (
    <article>
      <div className="box-wrapper grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-20">
        ...
        <div
  key={item.id}
 className=" shadow-[3px_3px_14px_1px_black]
 border-4 border-[#F4F4F4] h-[23rem] m-4 bg-cover bg-center p-6 text-white bg-opacity-80 flex flex-col justify-between items-center"
